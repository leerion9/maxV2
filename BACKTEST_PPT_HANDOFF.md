...
> **마지막 갱신**: 2026-07-02 (거래대금 sweep·구간·종가매수·진입조건 백테스트 + 엔진 확장)
> **다음 작업**: (1) 거래대금 **장중 누적** proxy 백테스트 (분봉/틱 필요) (2) vol_bands 300%+ 구간 vs 장중 300% 조기진입 가설 검증 (3) 갭업 미체결 — 별도 논의
...
2. **장중 300% 조기진입** — 일봉으로 검증 불가. 분봉 proxy 필요.
